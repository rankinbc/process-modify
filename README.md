...
* You can also edit memory directly using a hex editor. This is useful in finding where specific variables are located.
...
Here are 2 videos demonstrating the program on an N64 emulator:<br><br>
